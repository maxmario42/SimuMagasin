...
to chercherSortie
    ...
    if (distancexy arrivee-x arrivee-y) > (distancexy arrive1-x arrive1-y)
    [
      if (dxi != arrive1-x or dyi != arrive1-y)
      [
        set arrivee-x arrive1-x
        set arrivee-y arrive1-y
      ]
    ]
    if (distancexy arrivee-x arrivee-y) > (distancexy arrive2-x arrive2-y)
    [
      if (dxi != arrive2-x or dyi != arrive2-y)
      [
        set arrivee-x arrive2-x
        set arrivee-y arrive2-y
      ]
    ]
    if (distancexy arrivee-x arrivee-y) > (distancexy arrive3-x arrive3-y)
    [
      if (dxi != arrive3-x or dyi != arrive3-y)
      [
        set arrivee-x arrive3-x
        set arrivee-y arrive3-y
      ]
    ]
    if (distancexy arrivee-x arrivee-y) > (distancexy arrive4-x arrive4-y)
    [
      if (dxi != arrive4-x or dyi != arrive4-y)
      [
        set arrivee-x arrive4-x
        set arrivee-y arrive4-y
      ]
    ]
